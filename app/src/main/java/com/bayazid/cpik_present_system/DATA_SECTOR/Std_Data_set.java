...
public class Std_Data_set {
   private String First_Name,Last_Name,College_Roll,Reg_Number,DbPathId,DbPathIdClass;
   ...
   private int posi;
    ...
    public Std_Data_set(String DbPathId,String DbPathIdClass){
        this.DbPathId=DbPathId;
        this.DbPathIdClass=DbPathIdClass;
    }
 ...
 //db path id
    ...
    //db path id DbPathIdClass
    public String getDbPathIdClass() {
        return DbPathIdClass;
    }
    public void setDbPathIdClass(String DbPathIdClass) {
        this.DbPathIdClass = DbPathIdClass;
    }
